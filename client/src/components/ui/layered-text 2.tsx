      ...
      <ul className="list-none p-0 m-0 flex flex-col items-center">
        {lines.map((line, index) => {
          ...
          return (
            ...
            >
              <p
                className="px-[15px] align-top whitespace-nowrap m-0 transition-colors duration-300"
                style={
                  {
                    height: `${lineHeight}px`,
              ...
              <p
                className="px-[15px] align-top whitespace-nowrap m-0 transition-colors duration-300 text-ted-red"
                style={
                  {
                    height: `${lineHeight}px`,
                    lineHeight: `${lineHeight - 5}px`,
